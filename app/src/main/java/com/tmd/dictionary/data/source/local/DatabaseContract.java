...
public class DatabaseContract {
    public class JpnVieContract {
        ...
        public class RelateWord implements BaseColumns {
            public static final String TABLE_NAME = "jpn_vie_relate_word";
        ...
        public class WordEx implements BaseColumns {
            public static final String TABLE_NAME = "jpn_vie_word_ex";
            public static final String COLUMN_WORD_ID = "word_id";
    ...
    public class KanjiContract {
        ...
        public class ComponentLookUp implements BaseColumns {
            public static final String TABLE_NAME = "kanji_component_lookup";
            public static final String COLUMN_KANJI = "kanji_id";
            public static final String COLUMN_RADICAL_ID = "radical_id";
        }

        public class KanjiBase implements BaseColumns {
    ...
    public class VieJpnContract {
        ...
        public class WordEx implements BaseColumns {
            public static final String TABLE_NAME = "vie_jpn_word_ex";
            public static final String COLUMN_WORD_ID = "word_id";
            public static final String COLUMN_EX_ID = "ex_id";
        }
